            ...
            <p>To check if you have python installed on a Windows PC, search in the start bar for Python or run the following on the Command Line (cmd.exe):</p>
             ...
             <div>
              ...
              <div>
                ...
                <div>
                  <h2>Example</h2>
                  <h3>if 5&gt;2: <br/><div></div>print("Five is greater than two!")</h3>
                </div>
                <div>
                ...
                <div>
                  <h2>Example</h2>
                  <h3>if 5 &gt; 2: <br/><div></div> print("Five is greater than two!") <br/><div></div>if 5 &gt 2:<br/><div></div>print("Five is greater than two!") </h3>
                ...
                <div>
                  <h2>Example</h2>
                  <h4>Syntax Error:</h4>
                  <h3>if 5 &gt; 2:<br/><div></div>print("Five is greater than two!")<br/><div></div> print("Five is greater than two!")</h3>
                ...
                <div>
                  ...
                  <div>Comments starts with a #, and Python will ignore them:</div>
                  <div>
                    <h3>Example</h3>
                    <h3>#This is a comment  <br/>print("Hello, World!")</h3>
