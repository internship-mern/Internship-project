    ...
    <>
      <div className="side-div-container"  style={containerStyle} >
        <ul id="scroll">
          ...
          <li>
            <a href="#start">C++ Get Started</a>
          </li>
          <li>
            <a href="#quick">C++ Quickstart</a>
          </li>
          <li>
            <a href="#comm">C++ Comments</a>
          </li>
          <li>
            <a href="#multi">C++ Multi-line Comments</a>
          </li>
          <li>
            <a href="#var">C++ Variables</a>
          </li>
          <li>
            <a href="#vt">Add Variables Together</a>
          </li>
          <li>
            <a href="#ident">C++ Identifiers</a>
          </li>
          <li>
            <a href="#cons">Constants</a>
          </li>
          <li>
            <a href="#user">C++ User Input</a>
          </li>
          <li>
            <a href="#simp">Creating a Simple Calculator</a>
          </li>
          <li>
            <a href="#data">C++ Data Types</a>
          </li>
          <li>
            <a href="#num">Numeric Types</a>
          </li>
          <li>
            <a href="#bool">Boolean Types</a>
          </li>
          <li>
            <a href="#char">Character Types</a>
          </li>
          <li>
            <a href="#str">String Concatenation</a>
          </li>
          <li>
            <a href="#app">Append</a>
          </li>
          <li>
            <a href="#add">Adding Numbers and Strings</a>
          </li>
          <li>
            <a href="#string">String Length</a>
          </li>
          <li>
            <a href="#inp">User Input Strings</a>
          </li>
          <li>
            <a href="#cond">C++ Conditions and If Statements</a>
          </li>
          <li>
            <a href="#ifs">The if Statement</a>
          </li>
          <li>
            <a href="#else">The else Statement</a>
          </li>
          <li>
            <a href="#swi">C++ Switch Statements</a>
          </li>
          <li>
            <a href="#bre">The break Keyword</a>
          </li>
          <li>
            <a href="#loop">C++ Loops</a>
          </li>
        </ul>
      </div>
      <div class="color">
        ...
        <div class=" content">
          <ul>
            <li>
              ...
              high-performance applications.<br></br>
            </li>
            <li>
        ...
        <div class=" content">
          C++ is one of the world's most popular programming languages.<br></br>
          <ul>
            <li>
              C++ can be found in today's operating systems, Graphical User
              Interfaces, and embedded systems.<br></br>
            </li>
            <li>
              {" "}
              ...
              development costs.<br></br>
            </li>
            <li>
              C++ is portable and can be used to develop applications that can
              be adapted to multiple platforms.<br></br>
            </li>
            <li>
              C++ is fun and easy to learn!<br></br>
            </li>
            <li>
        ...
        <div class=" content">
          ...
          <div class=" content">
            ...
            will install the text editor with a compiler.<br></br>
            <h2 id="quick">C++ Quickstart</h2>
            <div class=" content">
              Let's create our first C++ file.<br></br>
              Open Codeblocks and go to{" "}
              <span>
                <b>File &gt; New &gt; Empty File.</b>
              </span>
              <br></br>
              Write the following C++ code and save the file as
              myfirstprogram.cpp <b>(File&gt;Save File as):</b>
            </div>
            <img src="https://www.w3schools.com/cpp/codeblocks2020.png"></img>
            <div class=" content">
              Then, go to <b>Build &gt; Build and Run </b>to run (execute) the
            ...
            <div class=" content">
              Variables are containers for storing data values. In C++, there
              are different types of variables (defined with different
              keywords), for example:
              <ul>
                <li>
                  <b>int </b>- stores integers (whole numbers), without
            ...
            <h3>Syntax</h3>
            <div class=" content">type variableName = value;</div>
            <br></br>
          </div>
          <div class=" content">
            Where type is one of C++ types (such as int), and variableName is
            the name of the variable (such as <b>X</b>or <b>myName</b>). The
            equal sign is used to assign values to the variable.<br></br>
            To create a variable that should store a number, look at the
            following example:
          </div>
          <h3>Example</h3>
          <div class=" content">
            Create a variable called myNum of type int and assign it the value
            15:
          </div>
          <br></br>
          <div class=" content">
          ...
          <div class=" content">A demonstration of other data types:</div>
          <br></br>
          <h3>Example</h3>
          <br></br>
          <div class=" content">
            int myNum = 5;{" "}
            <span>// Integer (whole number without decimals)</span> <br></br>
            double myFloatNum = 5.99;{" "}
            <span>// Floating point number (with decimals)</span>
            <br></br>
            char myLetter = 'D'; <span>// Character</span> <br></br>
            string myText = "Hello"; <span>// String (text)</span>
            <br></br>
            bool myBoolean = true; <span>// Boolean (true or false)</span>
            <h2 id="vt">Add Variables Together</h2>
            <div class=" content">
            ...
            <div class=" content">
              All C++ <b>variables</b> must be <b>identified</b> with{" "}
              <b>unique names</b>.<br />
              ...
              <br />
              <b> Note:</b> It is recommended to use descriptive names in order
              ...
              <div class=" content">
                ...
                <b>unchangeable and read-only</b>):
              </div>
            </div>
            <h3>Example</h3>
            <div class=" content">
          ...
          <div class=" content">
            ...
            This is not a built-in type, but it behaves like one in its most
            basic usage. String values must be surrounded by double quotes:
          </div>
          <h3>Example</h3>
          <div class=" content">
          ...
          <h2 id="str">String Concatenation</h2>
          <div class=" content">
            The + operator can be used between strings to add them together to
            make a new string. This is called <b>concatenation</b>:
          </div>
          <h3>Example</h3>
          <div class=" content">
          ...
          <div class=" content">
            ...
            space between John and Doe on output. However, you could also add a
          ...
          <div class=" content">
            ...
            can perform certain operations on strings. For example, you can also
          ...
          <div class=" content">
            WARNING!
            <br />
            C++ uses the + operator for both <b>addition </b>and
            ...
            <h3>Output</h3>
            <div class=" content">The length of the txt string is: 26</div>
          </div>
          ...
          <h3>Syntax</h3>
          <div class=" content">switch(expression)</div>
          <div class=" content">
            <br></br>
          ...
          <h2 id="bre">The break Keyword</h2>
          <div class=" content">
          ...
          <div class=" content">
            The <b>default</b> keyword specifies some code to run if there is no
            case match:
          </div>
          <div class=" content"></div>
          <h2 id="">C++ While Loop</h2>
          <h2 id="loop">C++ Loops</h2>
          <div class=" content">
            <ul>
              <li>
          ...
          <h2 id="">C++ While Loop</h2>
          <div class=" content">
            The <b>while</b> loop loops through a block of code as long as a
            specified condition is <b>true</b>:<h3>Syntax</h3>
            <div class=" content">
              while (condition) <br />
            ...
            <div class=" content">
              ...
              while (i &lt; 5)
              <br />
              <b>Note:</b> Do not forget to increase the variable used in the
          ...
          <div class=" content">
            ...
            <br />
            <b>Statement 1</b> is executed (one time) before the execution of
            the code block.
            <br />
            <b>Statement 2 </b>defines the condition for executing the code
            block.
            <br />
            <b>Statement 3</b> is executed (every time) after the code block has
            been executed.
            <br />
          ...
          <div class=" content">
            ...
            less than 5). If the condition is true, the loop will start over
